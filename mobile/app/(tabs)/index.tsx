    ...
    <View style={styles.container}>
      ...
      <View style = {styles.postView}>
        ...
        <View style={styles.topSection}>
            <Ionicons name="person-circle" size={30} color="#575A4B" style={styles.iconLeft} />
            <Text  style={styles.modalText}> Ime i prezime </Text>
        </View>

        <View style={styles.middleSection}>
        <Image 
          source={{ uri: 'file:///Users/klarakatic/Documents/projektR/foody/mobile/images/objava1.jpg' }} 
          style={styles.image} 
        />
        </View>
          
        <View style={styles.bottomSection}>
        <TouchableOpacity onPress={() => setHeartColor(prevColor => prevColor === '#575A4B' ? '#FF0000' : '#575A4B')}>
            <Ionicons name="heart" size={24} color={heartColor} style={styles.icon} />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => setCommentColor(prevColor => prevColor === '#575A4B' ? '#FF0000' : '#575A4B')}>
            <Ionicons name="chatbubble" size={24} color={commentColor} style={styles.icon} />
          </TouchableOpacity>
        </View>
