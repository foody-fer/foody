            ...
            <View className="bg-white rounded-xl p-6 w-4/5">
              ...
              <View className="items-center mb-4 w-72 h-10">
                <TouchableOpacity onPress={() => setShowDatePicker(true)}>
                  <Text className="text-center text-lg text-[#718355] mb-2 bg-white py-1 px-4 rounded-full w-full h-10 border border-[#718355]">
              ...
              <TouchableOpacity
                className="bg-[#718355] py-2 px-4 rounded-full items-center w-50s"
