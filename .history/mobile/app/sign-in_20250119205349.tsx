...
const SignIn = () => {
  ...
  return (
    <ScrollView className="flex-grow bg-[#CFE1B9] p-4 font-quicksand">
      ...
      <View className="bg-white rounded-2xl p-4 shadow-md w-11/12 max-w-md mx-auto">
        <Text className="text-lg font-bold text-center text-[#373737] mb-2">
          Welcome Back
        </Text>
        <Text className="text-sm text-center text-[#575A4B] mb-4">
          We've missed you! Log in to continue.
        </Text>

        <View className="mb-3">
          <TextInput
            className="border border-[#AEB5A1] rounded-full px-4 py-3 bg-[#F8FBEF] text-sm"
