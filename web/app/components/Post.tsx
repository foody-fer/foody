        ...
        <div className="h-auto w-[93%] bg-gray-100 flex flex-col gap-3 mb-4 p-2 rounded-lg">
            ...
            <div className="flex flex-row justify-between">
                <div className="flex flex-row gap-2">
                    <img src="./images/user_icon.jpg" alt="user pic" height={40} width={40} className="rounded-full flex-1"/>
            ...
            <div className="flex flex-col gap-2">
                <img src={pic} alt="food" className="w-full rounded-md"/>
            ...
            <div className="flex flex-row justify-between text-xs">
                <div className="flex flex-row gap-2">
                    <div className={"flex flex-row  bg-white rounded-full p-1 transition duration-300 "+(likes ? 'text-resedaGreen font-semibold' : ' text-textColor')}>
